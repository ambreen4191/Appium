...
public class ExtentManager {
	...
	private static ExtentTest test;
	    public static ExtentReports createInstance(String fileName) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Abacus tester");
	        extent.setSystemInfo("Organization", "Code Automation");
	        extent.setSystemInfo("Build No", BaseClass.BuildNumber);
